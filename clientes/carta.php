...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="wrapper">
        ...
        <main class="container my-5">
            <h1 class="mb-5 titulocarta">Carta - Restaurante La Despensa</h1>

            <section class="category">
                <h2 class="titulocarta2">🥗 Entrantes</h2>
                <div class="menu-item">
            ...
            <section class="category">
                <h2 class="titulocarta2">🍅 Platos Principales</h2>
                <div class="menu-item">
            ...
            <section class="category">
                <h2 class="titulocarta2">🍮 Postres Caseros</h2>
                <div class="menu-item">
            ...
            <section class="category">
                <h2 class="titulocarta2">🍷 Bebidas</h2>
                <div class="menu-item">
